...
const s = StyleSheet.create({
  ...
  avatarFrame: { width: 80, height: 80, borderRadius: 40, borderWidth: 2.5, borderColor: '#d4a574', alignItems: 'center', justifyContent: 'center', marginBottom: 14, shadowColor: '#d4a574', shadowOpacity: 0.35, shadowRadius: 14, shadowOffset: { width: 0, height: 0 }, elevation: 8 },
  ...
  hostHandle: { fontSize: 12, color: 'rgba(255,255,255,0.45)', fontWeight: '500', marginTop: 2 },
  ...
  metricCard: { backgroundColor: '#fff', borderRadius: 16, padding: 16, shadowColor: '#0f172a', shadowOpacity: 0.06, shadowRadius: 16, shadowOffset: { width: 0, height: 4 }, elevation: 3, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  topCard: { width: '100%', backgroundColor: '#fff', borderRadius: 16, padding: 16, marginTop: 0, shadowColor: '#0f172a', shadowOpacity: 0.06, shadowRadius: 16, shadowOffset: { width: 0, height: 4 }, elevation: 3, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12, paddingLeft: 0, borderLeftWidth: 0 },
  ...
  activityList: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', shadowColor: '#0f172a', shadowOpacity: 0.06, shadowRadius: 16, shadowOffset: { width: 0, height: 4 }, elevation: 3, borderWidth: 1, borderColor: '#e2e8f0' },
